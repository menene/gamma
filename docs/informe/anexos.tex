...
\midrule
Gestor          & \texttt{revisor.gestor@gamma.gt} & \texttt{[COMPLETAR]} \\
Administrador   & \texttt{revisor.admin@gamma.gt}  & \texttt{[COMPLETAR]} \\
\bottomrule
\end{tabular}
\end{table}

\noindent\textbf{Dirección de acceso:} \texttt{[COMPLETAR URL]}
